    ...
    <el-row>
        <el-col :span="24">
            <div class="grid-content">
                ...
                <br>
                <el-button type="success" @click="editUser(id)">编辑</el-button>
                <el-button type="danger" @click="del(id)">删除</el-button>
...
import {delUser, getUser, postUser} from "../../api/user";
